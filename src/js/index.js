...
(function (window, document, store) {
  ...
  const mainWrap = document.querySelector(DOM.html);
  const addNoteForm = document.getElementById(DOM.addNoteForm);
  const editNoteForm = document.getElementById(DOM.editNoteForm);
